...
![scada_mqtt_diagram.drawio.svg](img/scada_mqtt_diagram.drawio.svg)
...
![route-sim.png](img/route-sim.png)
![route-sim-3.png](img/route-sim-3.png)
...
![qt-editor.png](img/qt-editor.png)

![qt-wysiwyg.png](img/qt-wysiwyg.png)
...
*✍️ Téléchargez [le projet Qt ici](img/qt-nmea-fleet-visualizer.zip). Les modifications à apporter dans la suite du TP se font dans ce projet.*
...
![qtcreator-build-run.webp](img/qtcreator-build-run.webp)
