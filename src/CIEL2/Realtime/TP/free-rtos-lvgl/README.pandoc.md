...
![lvgl_canvas.png](./img/lvgl_canvas.png)
![lvgl_canvas_2.png](./img/lvgl_canvas_2.png)
...
Et ajoutez le fichier `lv_conf.h` ([récupérable ici](three_screens/lv_conf.h)) dans le dossier `include`.

Une fois le projet configuré, il est **nécessaire d'ajouter deux fichiers** dans le dossier `lib/lvgl_freertos_glue`: 
- `lvgl_freertos_glue.cpp` ([récupérable ici](three_screens/lib/lvgl_freertos_glue.cpp))
- `lvgl_freertos_glue.hpp` ([récupérable ici](three_screens/lib/lvgl_freertos_glue.hpp))
...
![screen_light.jpg](./img/screen_light.jpg)

![screen_temp.jpg](./img/screen_temp.jpg)

![screen_settings.jpg](./img/screen_settings.jpg)
