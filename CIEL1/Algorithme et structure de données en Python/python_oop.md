...
> Plus de détails : https://en.wikipedia.org/wiki/Object-oriented_programming

---

## La POO en Python

Python est un langage multi-paradigme, cependant, il met la POO au coeur de son fonctionnement :
