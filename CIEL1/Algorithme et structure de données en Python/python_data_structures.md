...
Ces structures de données contiennent plusieurs éléments et sont dites **itérables**.
Il est donc possible de les parcourir **élément par élément** à l’aide d’une boucle.
